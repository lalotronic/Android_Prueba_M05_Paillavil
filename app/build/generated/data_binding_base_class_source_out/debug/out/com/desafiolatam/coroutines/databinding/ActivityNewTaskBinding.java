...
public final class ActivityNewTaskBinding implements ViewBinding {
  ...
  @NonNull
  public final AppCompatTextView newTask;
  ...
  private ActivityNewTaskBinding(@NonNull ConstraintLayout rootView,
      @NonNull TextInputEditText description, @NonNull AppCompatTextView newTask,
      @NonNull AppCompatButton save, @NonNull TextInputEditText title) {
  ...
  public static ActivityNewTaskBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.newTask;
      AppCompatTextView newTask = ViewBindings.findChildViewById(rootView, id);
      if (newTask == null) {
        break missingId;
      }
      ...
      return new ActivityNewTaskBinding((ConstraintLayout) rootView, description, newTask, save,
          title);
    }
